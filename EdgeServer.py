...
class EdgeServer:
    def __init__(self, server_id, num_clients):
        ...
        self.transmitter_power = 0.8  # Example: Higher power compared to device-to-edge
    ...
    def compute_cloud_communication_energy(self, size_model_bits, channel_capacity=1e7):
        """
        Compute energy for transmitting data to the cloud server.
        """
        communicationLatency = size_model_bits / channel_capacity
